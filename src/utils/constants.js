export const PERSONAJES = [
  {
    id: "esli-6",
    name: "E.S.L.I #6",
    image: "/images/characters/tu.webp",
    description: "Eres el último sobreviviente del E.S.L.I., un antiguo tripulante marcado por la tragedia y forjado en el exilio. Silencioso, hábil y determinado, tu vida cambió para siempre tras el ataque de la Tecnomatrix. Con una mezcla de dolor, culpa y una voluntad indomable, te conviertes en una fuerza solitaria que atravesará galaxias por una sola misión: rescatar al comandante Esli y vengar a tu familia perdida.",
  },
  {
    id: "esli",
    name: "Esli",
    image: "/images/characters/esli.webp",
    description: "El comandante Esli es un líder noble y determinado, conocido en los rincones más oscuros de la galaxia por su compasión inquebrantable y su valentía frente a la injusticia. Fundador del E.S.L.I. (Ejército Solar de Liberación Interestelar), dedicó su vida a proteger a los oprimidos sin esperar nada a cambio. Astuto, carismático y profundamente humano, Esli es el corazón de una causa que se niega a morir.",
  },
  {
    id: "lord-funken",
    name: "Lord Funken",
    image: "/images/characters/lord-funken.webp",
    description:
      "Antes de ser conocido como Lord Funken, su nombre era Kael Vortan, un brillante ingeniero y piloto en el sistema Zynex. Dedicó su vida a desarrollar tecnología energética que ayudaría a salvar a su planeta de una inminente extinción energética. Pero su investigación fue robada por el Alto Consejo Galáctico, que la utilizó para alimentar armas destructivas. Traicionado y humillado, Kael intentó sabotear el proyecto, pero fue atrapado en una explosión de antimateria que lo fusionó con su propia tecnología. Su cuerpo ahora irradia energía pura. Su mente, consumida por el rencor, se convirtió en una tormenta ambulante. Se unió a la Tecnomatrix como su general de asalto, prometiendo que la galaxia conocería el verdadero poder de un rayo traicionado.",
  },
  {
    id: "vuv-ulubu",
    name: "VuV-Ulubu",
    image: "/images/characters/vuv-ulubu.webp",
    description:
